...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 04, 2021 at 07:58 PM
...
(1, 1, 26, '2021-11-01 09:39:18'),
(2, 1, 25, '2021-11-01 09:46:27'),
(3, 1, 24, '2021-11-01 09:46:28'),
(4, 1, 23, '2021-11-01 09:46:30'),
(5, 1, 22, '2021-11-01 09:46:31'),
(6, 26, 1, '2021-11-04 08:49:01');
...
CREATE TABLE `friends` (
  ...
  `friender_id` mediumint(9) NOT NULL,
  `friendee_id` mediumint(9) NOT NULL,
  `date` datetime NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `friends` (`f_id`, `friender_id`, `friendee_id`, `date`) VALUES
(1, 6, 1, '2021-11-02 11:23:44'),
(4, 1, 2, '2021-11-04 16:25:08'),
(11, 1, 26, '0000-00-00 00:00:00'),
(12, 1, 25, '0000-00-00 00:00:00'),
(13, 1, 24, '0000-00-00 00:00:00'),
(18, 9, 1, '2021-11-04 19:28:25'),
(21, 1, 9, '2021-11-04 11:32:03');
...
--
ALTER TABLE `friends`
  MODIFY `f_id` mediumint(9) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;

--
-- AUTO_INCREMENT for table `likes`
--
ALTER TABLE `likes`
  MODIFY `like_id` mediumint(9) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
